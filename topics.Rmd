...
|  | F 3/1 | Real and Complex Eigenvalues | eigenvalues and applications | Assigned: Homework 4 | TBA |
| **8** | M 3/4 | _Spring Vacation_ | - | - | - |
|  | W 3/6 | _Spring Vacation_ | - | - | - |
|  | F 3/8 | _Spring Vacation_ | - | - | - |
| **9** | M 3/11 | Eigenvectors | TBA | - | TBA |
|  | W 3/13 | Eigenvectors for Distinct Eigenvalues | TBA | - | TBA |
|  | F 3/15 | Eigenvectors for Repeated Eigenvalues | TBA | - | TBA |
...
|  | F 3/29 | _Easter Vacation_ | - | Assigned: Homework 5 | - |
| **12** | M 4/1 | _Easter Vacation_ | - | - | - |
|  | W 4/3 | Singular Vectors | TBA | - | TBA |
|  | F 4/5 | Singular Value Decomposition (SVD) | TBA | Assigned: Homework 6 | TBA |
